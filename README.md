...
**Applications:** We apply PerturbGen to three human single-cell datasets. In an in vivo immune challenge, PerturbGen predicts that IL1B knockout in myeloid cells attenuates later cytokine–interferon programs. In hematopoiesis, anchoring perturbation-induced programs to human genetics enables simulation of monogenic blood disorders and reveals lineage-specific programs. In skin organoids, PerturbGen predicted that Wnt activation enhances stromal differentiation, recapitulating prenatal skin trajectories—findings validated by experimentally activating Wnt signaling. PerturbGen extends perturbation modeling from static to dynamic cellular systems and supports in silico, trajectory-aware perturbation atlases for therapeutic discovery.
