...
TOKENID_PATH = "T_perturb/tokenized_data/hspc_pbmc_median_all_tissue_all_tf/tokenid_to_rowid_5000_hvg.pkl"

# Safety check (fail fast)
for path in [ENCODER_PATH, MAPPING_PATH]:
...
class TestCountDecoder(MaskCheckpointFixture, unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        super().setUpClass()  # builds masking ckpt
