...
#BSUB -J hspc_perturb_cluster_[1-11]%4 # job array with 35 jobs, max 4 running at the same time
#BSUB -n 4 # number of cores
#BSUB -G team361 # groupname for billing team361
#BSUB -cwd /lustre/scratch126/cellgen/lotfollahi/kl11/ # working directory
#BSUB -o T_perturb/perturbgen/logs/delete_TF_%J_%I.out # output file
#BSUB -e T_perturb/perturbgen/logs/delete_TF_%J_%I.err # error file
...
CONFIG_PATH="T_perturb/perturbgen/configs/eval/HSPC/delete_src_inference_perturbation_jobarray.yaml"
TMP_CONFIG_PATH="T_perturb/perturbgen/configs/eval/HSPC/delete_src_generate_perturbation_${PERTURBED_GENE}_${LSB_JOBID}.yaml"
