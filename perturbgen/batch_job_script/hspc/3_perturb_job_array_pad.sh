...
#BSUB -o T_perturb/perturbgen/logs/pad_TF_%J_%I.out # output file
#BSUB -e T_perturb/perturbgen/logs/pad_TF_%J_%I.err # error file
...
CONFIG_PATH="T_perturb/perturbgen/configs/eval/HSPC/pad_src_inference_perturbation_jobarray.yaml"
TMP_CONFIG_PATH="T_perturb/perturbgen/configs/eval/HSPC/pad_src_generate_perturbation_${PERTURBED_GENE}_${LSB_JOBID}.yaml"
