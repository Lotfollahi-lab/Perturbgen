...
# --generate True \
# --ckpt_count_path "./T_perturb/perturbgen/Model/checkpoints/20240522_0857_tcell_extrapolate_5e-05_wd_0.01_batch_64_zinb_tp_1-2_s_100-epoch=19.ckpt" \
...
--splitting_mode stratified \
--generate True \
--ckpt_count_path "./T_perturb/perturbgen/Model/checkpoints/20240822_1920_cellgen_train_count_lr_0.005_wd_0.001_batch_64_zinb_tp_1-2_s_42-epoch=19.ckpt" \
--output_dir "./T_perturb/perturbgen/plt/res/cytoimmgen" \
--src_dataset "./T_perturb/tokenized_data/cytoimmgen/dataset_hvg_src_transformer/0h.dataset" \
--tgt_dataset_folder "./T_perturb/tokenized_data/cytoimmgen/dataset_hvg_tgt" \
--src_adata "./T_perturb/tokenized_data/cytoimmgen/h5ad_pairing_hvg_src/0h.h5ad" \
