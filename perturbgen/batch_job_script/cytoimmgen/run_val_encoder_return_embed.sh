...
--return_embed True \
--generate False \
--ckpt_masking_path "./T_perturb/perturbgen/Model/checkpoints/20240809_1245_wo_residual_masking_lr_0.0001_wd_0.0001_batch_64_mlmp_0.15_tp_1-2_s_100-epoch=19.ckpt" \
