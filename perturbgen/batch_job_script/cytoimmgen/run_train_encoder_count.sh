...
# --ckpt_masking_path "./T_perturb/perturbgen/Model/checkpoints/20240522_0248_tcell_extrapol_lr_0.0001_wd_0.0001_batch_64_mlmp_0.15_tp_1-2_s_100-epoch=149.ckpt" \
...
--splitting_mode stratified \
--output_dir "./T_perturb/perturbgen/plt/res/cytoimmgen" \
--ckpt_masking_path ".//T_perturb/perturbgen/Model/checkpoints/20240809_1245_cellgen_train_masking_lr_0.0001_wd_0.0001_batch_64_mlmp_0.15_tp_1-2_s_100-epoch=19.ckpt" \
--src_dataset "./T_perturb/tokenized_data/cytoimmgen/dataset_hvg_src_transformer/0h.dataset" \
--tgt_dataset_folder "./T_perturb/tokenized_data/cytoimmgen/dataset_hvg_tgt" \
--src_adata "./T_perturb/tokenized_data/cytoimmgen/h5ad_pairing_hvg_src/0h.h5ad" \
--tgt_adata_folder "./T_perturb/tokenized_data/cytoimmgen/h5ad_pairing_hvg_tgt" \
