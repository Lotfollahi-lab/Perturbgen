...
#BSUB -o T_perturb/log/return_SKO_embed_%J.out # output file
#BSUB -e T_perturb/log/return_SKO_embed_%J.err # error file
...
RES_NAME="lps/embedding_100MedE0e8WNT_int_2k_all_tps_SKONew_time_pos_sin"
...
--return_attn False \
--generate False \
--ckpt_masking_path "/lustre/scratch126/cellgen/lotfollahi/dv8/trace/T_perturb/T_perturb/plt/res/lps/Our_median/interpolation_sko_e0100M_time_pos_sin_cosine_withControl_2k_WNT/res/checkpoints/20250731_1059_cellgen_train_masking_lr_0.0001_wd_0.0001_batch_64_ptime_pos_sin_m_cosine_tp_1-2-3-4_s_0-epoch=08.ckpt" \
...
--tokenid_to_rowid '/lustre/scratch126/cellgen/lotfollahi/dv8/trace/T_perturb/T_perturb/pp/res/OURmed100m_sko_all_tps_2k_genesIncluded_hvg_100Med_new/tokenid_to_rowid_2000_hvg.pkl' \
--encoder scmaskgit \
