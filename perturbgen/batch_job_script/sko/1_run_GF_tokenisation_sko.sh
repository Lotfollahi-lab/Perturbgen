...
#BSUB -o T_perturb/log/stratified_pairing_GF_tokenisation_SKO_100m%J.out # output file
#BSUB -e T_perturb/log/stratified_pairing_GF_tokenisation_SKO_100m%J.err # error file
...
--dataset OURmed100m_sko_all_tps_2k_genesIncluded_hvg_100Med_new \
