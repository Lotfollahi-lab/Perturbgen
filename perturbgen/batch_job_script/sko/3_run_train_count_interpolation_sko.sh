...
#BSUB -o T_perturb/log/sko_count_interpolation_2k_%J.out # output file
#BSUB -e T_perturb/log/sko_count_interpolation_2k_%J.err # error file
...
RES_NAME="lps/ourMED_median/count_sko_Med100M_cosine_e0e8WNT_2k_time_pos_sin"
