...
#BSUB -o logs/lps_count_alltps_s0_ep09_%J.out # output file
#BSUB -e logs/lps_count_alltps_s0_ep09_%J.err # error file
#BSUB -M 50000  # RAM memory part 2. Default: 100MB
#BSUB -R 'select[mem>50000] rusage[mem=50000]' # RAM memory part 1. Default: 100MB
#BSUB -J lps_count_alltps_s0_ep09 # job name
...
--ckpt_masking_path "/lustre/scratch126/cellgen/lotfollahi/kl11/T_perturb/res/lps/all_tps/checkpoints/20251208_1241_cellgen_train_masking_lr_0.0001_wd_0.0001_batch_64_ptime_pos_sin_m_pow_tp_1-2-3_s_100-epoch=09.ckpt" \
