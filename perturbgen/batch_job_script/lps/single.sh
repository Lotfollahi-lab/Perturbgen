...
RES_DIR="/lustre/scratch126/cellgen/team298/dv8/trace_paper/trace_final/T_perturb/perturbgen/results"
...
python3 /lustre/scratch126/cellgen/team298/dv8/trace_paper/trace_final/T_perturb/perturbgen/val.py \
--test_mode count \
--split False \
--splitting_mode stratified \
--generate True \
--output_dir $RES_DIR/$RES_NAME \
--ckpt_count_path '/lustre/scratch126/cellgen/team298/dv8/trace_paper/trace_final/T_perturb/perturbgen/results/lps/count_interpolation_ourMED_ws_on2k_e9_noSplit_nodropout_subset_cond/checkpoints/20250211_1446_cellgen_train_count_lr_0.001_wd_0.001_batch_16_zinb_tp_1-3_s_42_pos_time_pos_sin_m_cosine-epoch=07.ckpt' \
