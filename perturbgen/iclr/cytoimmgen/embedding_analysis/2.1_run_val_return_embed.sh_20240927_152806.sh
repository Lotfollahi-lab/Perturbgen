...
--return_embed True \
--generate False \
--ckpt_masking_path "./T_perturb/perturbgen/iclr/cytoimmgen/embedding_analysis/res/checkpoints/20240927_1101_cellgen_train_masking_lr_0.0001_wd_0.0001_batch_64_psin_learnt_m_cosine_tp_1-2-3_s_42-epoch=09.ckpt" \
