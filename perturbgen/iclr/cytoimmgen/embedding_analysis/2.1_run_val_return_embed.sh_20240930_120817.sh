...
--return_embed True \
--generate False \
--ckpt_masking_path "./T_perturb/perturbgen/iclr/cytoimmgen/embedding_analysis/res/checkpoints/20240927_2353_cellgen_train_masking_lr_1e-05_wd_1e-05_batch_64_psin_learnt_m_cosine_tp_1-2-3_s_42-epoch=09.ckpt" \
