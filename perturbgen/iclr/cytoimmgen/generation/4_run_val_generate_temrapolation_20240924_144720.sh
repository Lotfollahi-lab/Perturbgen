...
--generate True \
--ckpt_count_path './T_perturb/perturbgen/iclr/cytoimmgen/masking_scheduler/res/checkpoints/20240921_1200_cellgen_train_count_lr_0.005_wd_0.001_batch_64_zinb_tp_1-3_s_42_mask_cosine-epoch=01.ckpt' \
...
--guided_gene_list_dir "./T_perturb/perturbgen/iclr/cytoimmgen/generation/20240920_marker_genelist_cytoimmgen.csv" \
--hvg_gene_list_dir "./T_perturb/perturbgen/iclr/cytoimmgen/generation/hvg_list.pkl" \
