...
RES_DIR="/lustre/scratch126/cellgen/lotfollahi/kl11/T_perturb/perturbgen/iclr"
...
# python3 $cwd/val.py \
python3 /lustre/scratch126/cellgen/lotfollahi/kl11/T_perturb/perturbgen/val.py \
--test_mode masking \
--split False \
--splitting_mode stratified \
--return_embed True \
--generate False \
--ckpt_masking_path "./T_perturb/perturbgen/iclr/cytoimmgen/embedding_analysis/res/checkpoints/20240928_1101_cellgen_train_masking_lr_1e-05_wd_1e-05_batch_64_psin_learnt_m_cosine_tp_1_s_42-epoch=19.ckpt" \
