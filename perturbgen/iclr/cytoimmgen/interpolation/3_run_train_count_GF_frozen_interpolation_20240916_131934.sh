...
source /lustre/scratch123/hgi/projects/healthy_imm_expr/t_generative/T_perturb/perturbgen/.torch25/bin/activate
cwd=$(pwd)
...
RES_DIR="/lustre/scratch123/hgi/projects/healthy_imm_expr/t_generative/T_perturb/perturbgen/iclr"
...
python3 /lustre/scratch123/hgi/projects/healthy_imm_expr/t_generative/T_perturb/perturbgen/train.py \
--train_mode count \
--split False \
--splitting_mode stratified \
--output_dir $RES_DIR/$RES_NAME \
--ckpt_masking_path "./T_perturb/perturbgen/iclr/cytoimmgen_interpolation/checkpoints/20240916_1100_cellgen_train_masking_lr_0.0001_wd_0.0001_batch_512_mlmp_0.15_tp_1-3_s_42-epoch=49.ckpt" \
