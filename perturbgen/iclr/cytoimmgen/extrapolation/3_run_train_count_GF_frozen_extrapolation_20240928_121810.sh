...
--ckpt_masking_path "./T_perturb/perturbgen/iclr/cytoimmgen/extrapolation/res/checkpoints/20240928_0953_cellgen_train_masking_lr_0.0001_wd_0.0001_batch_64_psin_learnt_m_cosine_tp_1-2_s_42-epoch=09.ckpt" \
