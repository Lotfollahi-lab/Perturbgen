...
from T_perturb.Model.trainerbc import CellGenTrainer, CountDecoderTrainer
...
if os.getcwd().split('/')[-1] != 'healthy_imm_expr':
    ...
    os.chdir('/lustre/scratch126/cellgen/team205/bair/CellGen_HK/')
...
def main() -> None:
    ...
    if os.getcwd().split('/')[-1] != 'healthy_imm_expr':
        # set working directory to root of repository
        os.chdir(
            '/lustre/scratch126/cellgen/team205/bair/CellGen_HK/T_perturb/T_perturb/'
        )
        print('Changed working directory to root of repository')
