...
tokenized_dir = (
    '/lustre/scratch123/hgi/projects/healthy_imm_expr/'
    't_generative/T_perturb/cytomeister/pp/res/dataset_hvg_tgt'
)
adata_dir = (
    '/lustre/scratch123/hgi/projects/healthy_imm_expr/'
    't_generative/T_perturb/cytomeister/pp/res/h5ad_pairing_hvg_tgt'
)
...
for i in range(len(dataset_dict_keys)):
    ...
    #     'T_perturb/cytomeister/pp/res/dataset/cytoimmgen_degs_random_pairing_16h.dataset',
    #     './res/Geneformer',
