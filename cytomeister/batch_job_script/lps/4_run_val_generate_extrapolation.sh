...
#BSUB -o logs/lps_generate_extra_s0_%J.out # output file
#BSUB -e logs/lps_generate_extra_s0_%J.err # error file
#BSUB -M 100000  # RAM memory part 2. Default: 100MB
#BSUB -R 'select[mem>100000] rusage[mem=100000]' # RAM memory part 1. Default: 100MB
#BSUB -J lps_generate_extra_s0 # job name
...
--ckpt_count_path 'T_perturb/res/lps/extrapolation/checkpoints/20250829_1700_cellgen_train_count_lr_0.001_wd_0.0001_batch_64_drop_0.1_zinb_tp_1-2_s_0_pos_time_pos_sin_m_pow-epoch=02.ckpt' \
