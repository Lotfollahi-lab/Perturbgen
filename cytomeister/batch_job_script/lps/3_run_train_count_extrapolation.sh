...
--ckpt_masking_path "T_perturb/res/lps/extrapolation/checkpoints/20250829_1756_cellgen_train_masking_lr_0.0001_wd_0.0001_batch_64_ptime_pos_sin_m_pow_tp_1-2_s_100-epoch=19.ckpt" \
