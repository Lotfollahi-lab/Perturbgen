...
--ckpt_masking_path 'T_perturb/res/eb/extrapolation/checkpoints/20250827_1737_cellgen_train_masking_lr_0.001_wd_0.0001_batch_64_ptime_pos_sin_m_uniform_tp_1-2-3_s_42-epoch=49.ckpt' \
