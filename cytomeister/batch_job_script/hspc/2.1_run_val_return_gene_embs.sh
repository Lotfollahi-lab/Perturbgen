...
--return_attn False \
--generate False \
--ckpt_masking_path "T_perturb/cytomeister/plt/res/hspc/pbmc_median/checkpoints/20250418_2222_cellgen_train_masking_lr_1e-05_wd_1e-05_batch_64_ptime_pos_sin_m_pow_tp_1-2_s_42-epoch=24.ckpt" \
...
# --deg_pkl_path 'T_perturb/cytomeister/plt/res/hspc/pbmc_median/figures/20250126_top250_DEG_lmpptissue_v_lmpprest_10k.pkl'
