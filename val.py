...
def get_args():
    ...
    parser.add_argument(
        ...
        default=(
            './T_perturb/pp/res/cytoimmgen/h5ad_pairing_hvg_src/0h.h5ad'
        ),
        help='path to src',
    )
    parser.add_argument(
...
def main() -> None:
    ...
    first_tgt_adata = next(iter(tgt_adatas.values()))
    n_genes = first_tgt_adata.shape[1]
    ...
    print(f'tgt_adata_tmp keys: {tgt_adatas.keys()}')
    
    tgt_adata_tmp = tgt_adatas[f'tgt_h5ad_tp'].copy()
    if args.split:
        ...
        # print(f'train_indices are a list from 0 to 99589')
    ...
    tgt_adata1 = sc.read_h5ad('/lustre/scratch126/cellgen/team205/bair/perturbench/perturbench_data/norman/h5ad_pairing_hvg_tgt_random_pairing/perturbation.h5ad')
    ...
    if torch.cuda.device_count() > 1:
        ...
        wandb_logger = WandbLogger(
            ...
            save_dir='./T_perturb/wandb/wandb',
            log_model='all',
        )  # noqa
    else:
        wandb_logger = WandbLogger(
