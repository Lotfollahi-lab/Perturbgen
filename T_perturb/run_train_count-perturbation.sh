#!/bin/bash
#SBATCH -J 3.3_test_counts_Norman2019
#SBATCH -o ../../logs/3.3_Norman2019_test_counts.out
#SBATCH -e ../../logs/3.3_Norman2019_test_counts.err
#SBATCH -t 12:00:00
#SBATCH -p gpu_p
#SBATCH --gres=gpu:1
...
--train_mode count \
--ckpt_file "20240428_2344_petra_mode_masking_lr_0.001_wd_0.001_batch_32_mlmp_0.3_hvg_pairing_GFpert.ckpt" \
--num_cells 0 \
