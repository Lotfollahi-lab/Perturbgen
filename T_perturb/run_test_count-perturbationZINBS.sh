...
#BSUB -J 8.2_testGFtunZINB # job name
...
python3 $cwd/val.py \
--ckpt_masking_file 20240515_1932_petra_mode_masking_lr_0.001_wd_0.0001_batch_16_mlmp_0.3_seed1_hvg_pairing_GFpert.ckpt \
--ckpt_count_file 20240516_2208_petra_mode_count_lr_0.001_wd_0.0001_batch_55_zinb_seed1_hvg_pairing_GFpert.ckpt \
