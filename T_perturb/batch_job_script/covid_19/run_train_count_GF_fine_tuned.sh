...
#BSUB -o logs/covid_count_%J.out # output file
#BSUB -e logs/covid_count_%J.err # error file
#BSUB -M 50000  # RAM memory part 2. Default: 100MB
#BSUB -R 'span[ptile=4]'  # Allocate 4 CPU cores per node
#BSUB -R 'select[mem>50000] rusage[mem=50000]' # RAM memory part 1. Default: 100MB
#BSUB -J covid_count # job name

# load cuda
module load cuda-12.1.1

# activate conda environment
source /lustre/scratch123/hgi/projects/healthy_imm_expr/t_generative/.cellgen_cuda12/bin/activate
cwd=$(pwd)
