...
#BSUB -gpu 'mode=exclusive_process:num=1:block=yes:gmodel=NVIDIAA100_SXM4_80GB' # request for exclusive access to gpu :gmodel=NVIDIAA100_SXM4_80GB
...
--config T_perturb/T_perturb/configs/eval/HSPC/mask_tgt_inference_perturbation_PRTN3.yaml
