...
#BSUB -gpu 'mode=exclusive_process:num=8:block=yes' # request for exclusive access to gpu
...
"20240517_1641_petra_train_masking_lr_0.0001"\
"_wd_0.0001_batch_64_mlmp_0.15_tp_1-3.ckpt" \
