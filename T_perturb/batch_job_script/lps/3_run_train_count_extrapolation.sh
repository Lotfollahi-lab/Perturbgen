...
#BSUB -o logs/lps_count_extrapolation_2k_%J.out # output file
#BSUB -e logs/lps_count_extrapolation_2k_%J.err # error file
#BSUB -M 50000  # RAM memory part 2. Default: 100MB
#BSUB -R 'select[mem>50000] rusage[mem=50000]' # RAM memory part 1. Default: 100MB
#BSUB -J lps_count_extrapolation_2k # job name
...
--ckpt_masking_path "/lustre/scratch126/cellgen/team361/kl11/t_generative/T_perturb/T_perturb/plt/res/lps/pbmc_median/extrapolation/res/checkpoints/20250506_2217_cellgen_train_masking_lr_0.0001_wd_0.0001_batch_64_ptime_pos_sin_m_pow_tp_1-2_s_42-epoch=19.ckpt" \
