...
#BSUB -M 50G  # RAM memory part 2. Default: 100MB
#BSUB -R 'span[ptile=16]'  # Allocate 4 CPU cores per node
#BSUB -R 'select[mem>50G] rusage[mem=50G]' # RAM memory part 1. Default: 100MB
#BSUB -J ipf_copd_masking # job name

# load cuda
module load cuda-12.1.1
# # deepspeed specific variables
# export TRITON_CACHE_DIR=/lustre/scratch123/hgi/projects/healthy_imm_expr/t_generative/.cache
# export TORCH_EXTENSIONS_DIR=/lustre/scratch123/hgi/projects/healthy_imm_expr/t_generative/.cache
