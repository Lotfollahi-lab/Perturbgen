...
--return_embed True \
--generate False \
--ckpt_masking_path "./T_perturb/T_perturb/Model/checkpoints/20240901_2209_ipf_copd_train_masking_lr_0.0001_wd_0.0001_batch_32_mlmp_0.15_ntask_2_s_42-epoch=19.ckpt" \
