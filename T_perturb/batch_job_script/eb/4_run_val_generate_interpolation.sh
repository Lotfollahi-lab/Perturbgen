...
#BSUB -gpu 'mode=shared:num=1:gmem=10000' # request for exclusive access to gpu, # request for exclusive access to gpu, 'mode=shared:num=2:gmem=10000'
...
RES_NAME="lps/generate_6h_interpolation_opthp_ourMED_e9_on2k_e9_nosplit_len150_C_T_new"
...
--ckpt_count_path '/lustre/scratch126/cellgen/team298/dv8/trace_paper/trace_final/T_perturb/T_perturb/results/lps/count_interpolation_ourMED_ws_on2k_T_C/checkpoints/20250220_1109_cellgen_train_count_lr_0.001_wd_0.001_batch_16_zinb_tp_1-3_s_42_pos_time_pos_sin_m_cosine-epoch=03.ckpt' \
