...
#BSUB -o T_perturb/logs/lps_generate_inter_2k_%J.out # output file
#BSUB -e T_perturb/logs/lps_generate_inter_2k_%J.err # error file
...
RES_NAME="lps/generate_6h_interpolation_opthp_ourMED_no6h_generation_n3_mCosine_defT_topkMar_e4_HVG_allData_noTC"
