...
def get_args():
    ...
    default='/lustre/scratch126/cellgen/team205/bair/perturbench/perturbench_data/norman/token_id_to_genename_hvg.pkl',
    )
...
def main() -> None:
    ...
    if args.test_mode == 'masking':
        ...
        tgt_adata = sc.read_h5ad('/lustre/scratch126/cellgen/team205/bair/perturbench/perturbench_data/norman/h5ad_pairing_hvg_tgt_random_pairing/perturbation.h5ad')
...
#     }
    ...
    if args.test_mode == 'masking':
        filename = (
            f'{run_id}_train_{args.test_mode}_lr_{args.cellgen_lr}_'
        ...
        filename = (
            f'{run_id}_train_{args.test_mode}_lr_{args.count_lr}_wd_{args.count_wd}_'
