...
#BSUB -o T_perturb/logs/eb_generate_intra_%J.out # output file
#BSUB -e T_perturb/logs/eb_generate_intra_%J.err # error file
#BSUB -M 20000  # RAM memory part 2. Default: 100MB
#BSUB -R 'select[mem>20000] rusage[mem=20000]' # RAM memory part 1. Default: 100MB
#BSUB -J eb_generate_intra # job name
...
RES_NAME="eb/pbmc_median/interpolation_new_topk"
...
--ckpt_count_path '/lustre/scratch126/cellgen/team298/dv8/trace_paper/trace_final/T_perturb/T_perturb/results/eb/pbmc_median/interpolation/checkpoints/20250426_0216_cellgen_train_count_lr_0.0001_wd_0.0001_batch_64_zinb_tp_1-2-4_s_0_pos_time_pos_sin_m_pow-epoch=99.ckpt' \
