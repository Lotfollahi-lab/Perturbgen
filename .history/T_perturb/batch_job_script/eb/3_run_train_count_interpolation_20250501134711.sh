...
#BSUB -o T_perturb/logs/eb_count_intrapolation_out_%J.out # output file
#BSUB -e T_perturb/logs/eb_count_intrapolation_out_%J.err # error file
#BSUB -M 20000  # RAM memory part 2. Default: 100MB
#BSUB -R 'select[mem>20000] rusage[mem=20000]' # RAM memory part 1. Default: 100MB
#BSUB -J eb_count_intra # job name
...
RES_NAME="eb/pbmc_median/interpolation_count_CFG"
...
--ckpt_masking_path '/lustre/scratch126/cellgen/team298/dv8/trace_paper/trace_final/T_perturb/T_perturb/results/eb/pbmc_median/interpolation_CFG_drop_prob_0.1/checkpoints/20250501_1326_cellgen_train_masking_lr_0.001_wd_0.0001_batch_64_ptime_pos_sin_m_pow_tp_1-2-4_s_100-epoch=49.ckpt' \
...
--seed 0 \
--d_model 768 \
> T_perturb/logs/eb_interpolation_count_$(date +%Y%m%d_%H%M%S).out \
2> T_perturb/logs/eb_interpolation_count_$(date +%Y%m%d_%H%M%S).err
