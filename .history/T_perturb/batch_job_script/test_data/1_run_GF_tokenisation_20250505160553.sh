...
#BSUB -o T_perturb/logs/random_pairing_GF_tokenisation_%J.out # output file
#BSUB -e T_perturb/logs/random_pairing_GF_tokenisation_%J.err # error file
...
--var_list annotation_simplified replicate cell_pairing_index  \
