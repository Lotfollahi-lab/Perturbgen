...
class CytoMeisterTrainer(LightningModule):
    def __init__(
        ...
        tokenid_to_rowid_path: str = (
            '/lustre/scratch126/cellgen/team298/dv8/trace_paper/trace_final/T_perturb/T_perturb/pp/res/2k_hvg_ourMED_all_tps_butNormal/tokenid_to_rowid_2000_hvg.pkl'
        ),
