...
class CellGenTrainer(LightningModule):
    def __init__(
        ...
        num_epochs: int = 5,
        warmup_epochs: int = 1,
        output_dir: str = '/lustre/scratch126/cellgen/team298/dv8/trace_paper/T_perturb/T_perturb/',
...
class CountDecoderTrainer(LightningModule):
    def __init__(
        ...
        iterations: int = 18,
        n_samples: int = 1,
        output_dir: str = '/lustre/scratch126/cellgen/team298/dv8/trace_paper/T_perturb/',
        mode: str = 'GF_fine_tuned',
